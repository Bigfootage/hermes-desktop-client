...
export interface HermesRun { id: string; status: string; approval?: HermesApprovalDetail; [key: string]: unknown }
export interface HermesApprovalDetail { id: string; tool?: string; command?: string; args?: string; description?: string; [key: string]: unknown }
...
export interface HermesClarifyRequest { question: string; inputType: 'text' | 'secret'; [key: string]: unknown }
